    ...
    <Card className="cards__example md-cell md-cell--12 md-cell--8-tablet">
      <CardText>
              ...
              <div className="homeroom-resource-card">
                <img className="homeroom-resource-img"  src={require("../../Assets/brainpop.png")} />
                <img className="homeroom-resource-img" src={require("../../Assets/studyisland.png")} /> 
                <img className="homeroom-resource-img" src={require("../../Assets/educationcity.png")} /> 
              </div>
      </CardText>
    </Card>
    <Card className="cards__example md-cell md-cell--12 md-cell--8-tablet">
      <CardText>
              ...
              <br></br>
              <div className="homeroom-resource-card">
                <img className="homeroom-resource-img"  src={require("../../Assets/shmoop.png")} />
                <img className="homeroom-resource-img" src={require("../../Assets/utahlibrary.png")} /> <br></br>
                <img className="homeroom-resource-img" src={require("../../Assets/peg.png")} />    
                <img className="homeroom-resource-img" src={require("../../Assets/imaginemath.png")} /> 
                <img className="homeroom-resource-img" src={require("../../Assets/ownit.png")} /> 
              </div>
      </CardText>
    </Card>
